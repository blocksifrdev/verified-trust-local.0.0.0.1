...
exports.detectInflectionPoints = detectInflectionPoints;
const inflectionPoint_1 = require("../core/inflectionPoint");
const NINETY_DAYS_MS = 90 * 24 * 60 * 60 * 1000;
function detectInflectionPoints(graph) {
    const points = [];
    const now = Date.now();
    for (const identity of graph.identities.values()) {
        ...
        if (identity.lastUsedAt) {
            ...
            if (now - lastUsed > NINETY_DAYS_MS) {
                points.push((0, inflectionPoint_1.createInflectionPoint)({
...
//# sourceMappingURL=inflectionPointDetector.js.map